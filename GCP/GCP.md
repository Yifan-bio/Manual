...
![Image of GCP Dashboard](Screenshots/GCP/createinstance-3.png)
  ...
  + Instance name
  + Region and zone: Select Region based on your requirement and cost of instance. (#NB make sure your bucket and instance is in the same region)
...
![Image of GCP Dashboard](Screenshots/GCP/createinstance-4.png)
    ...
    + Select Ubuntu 22.04 LTS for **Version** (Or the version you need)
    + Set the size of disk (Depend on how much you need)
